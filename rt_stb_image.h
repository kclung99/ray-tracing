...
public:
    ...
    rt_image(const char *image_filename)
    {
        ...
        // hunt for img file in likely locations
    ...
    {
        // return addr of RGB bytes at pixel x, y. return magenta if no img data
...
private:
    ...
    float *fdata = nullptr;         // linear fp pixel data
    ...
    {
        // convert linear fp pixel data to bytes
